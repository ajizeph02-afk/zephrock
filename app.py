...
st.title("Zephrock")
st.caption("Generalized Hoek-Brown → equivalent Mohr-Coulomb rock-mass strength "
           "calculator — a free, from-scratch alternative to the relevant core of "
           "Rocscience's RSData/RocData/RocLab.")
...
equivalent Mohr-Coulomb only -- not RSData's other failure criteria.
